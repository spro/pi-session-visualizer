...
export const sessionPanelButtonClassName = joinClassNames(
...
export const sessionPanelIconButtonClassName = joinClassNames(
...
export const sessionPanelCompactIconButtonClassName = joinClassNames(
...
export function getSessionPillBadgeClassName(
    ...
    return joinClassNames(pillBadgeBaseClassName, ...classNames)
}

export function getSessionLargePillBadgeClassName(
    ...classNames: Array<string | false | null | undefined>
) {
    return joinClassNames(largePillBadgeBaseClassName, ...classNames)
}

export function getSessionAbsoluteBadgeClassName(
    ...classNames: Array<string | false | null | undefined>
) {
    return joinClassNames(absolutePillBadgeBaseClassName, ...classNames)
}
